    ...
    <MainLayout>
        ...
        <div class="max-w-[880px] lg:ml-0 md:ml-[80px] md:pl-20 px-4 w-[100vw]">
            <div class="flex items-center md:justify-between">
                ...
                <label for="fileUser">
                    <img class="rounded-full object-fit md:w-[200px] w-[100px] cursor-pointer" src="https://i.pinimg.com/736x/26/e7/36/26e736cf248d865977f2fae061c356b7.jpg" alt="konfune ushio">
                    <!-- <img class="rounded-full object-fit md:w-[200px] w-[100px] cursor-pointer" src="https://picsum.photos/id/50/200/200" alt="konfune ushio"> -->
                </label>
                <input
                    id="fileUser"
                    class="hidden"
