    ...
    <div id="MainLayout" class="w-full h-screen">
        <div v-if="$page.url == '/'" id="TopNavHome" class="fixed z-30 md:hidden block w-full bg-white h-[61px] border-b border-b-gray-300">
            <div class="flex items-center justify-between h-full">
                <Link href="/">
                    <img class="w-[105px] j ml-6 cursor-pointer" src="/insta-logo.png" alt="insta Logo">
                </Link>
                ...
                <div class="flex items-center w-[50%]">
                    ...
                    <HeartOutline class="pl-4 pr-3" fillColor="#181818" :size="27" />
                </div>
            </div>
        </div>
        ...
        <div id="SideNav" class="fixed h-full bg-white xl:w-[280px] w-[80px] md:block hidden border-r border-r-gray-300">
            ...
            <Link href="/">
                <img src="/insta-logo-small.png" alt="insta logo" class="xl:hidden block w-[25px] mt-10 ml-[25px] mb-10 cursor-pointer">
                <img src="/insta-logo.png" alt="insta text logo" class="xl:block hidden w-[120px] mt-10 ml-6 mb-10 cursor-pointer">
            </Link>
            ...
            <div v-if="$page.url = '/'" id="SuggestionsSection" class="lg:w-4/12 lg:block hidden text-black mt-10">
                <Link href="/" class="flex items-center justify-between max-w-[300px]">
                    <div class="flex items-center">
                        <img src="https://i.pinimg.com/originals/14/e7/fd/14e7fde33ea0f19fe080aa57e77f7d8f.jpg" alt="" class="rounded-full z-10 w-[58px] h-[58px]">
                        <div class="pl-4">
                ...
                <Link href="/" class="flex items-center justify-between max-w-[300px] pb-2">
                    <div class="flex items-center">
                        <img src="https://i.pinimg.com/736x/38/39/c6/3839c65b1ee72c4468dcc2da24ec1f86.jpg" alt="" class="rounded-full z-10 w-[37px] h-[37px]">
                        <div class="pl-4">
                            <div class="text-black font-extrabold">NAME HERE</div>
                            <div class="text-gray-500 text-extrabold text-sm">NAME HERE</div>
                        </div>
                ...
                <div class="max-w-[300px] mt-5">
                    <div class="text-sm text-gray-400">About Help Press API Jobs Privacy Terms Location Language Meta Verified</div>
        ...
        <div id="BottomNav" class="fixed z-30 bottom-0 w-full md:hidden flex items-center justify-around bg-white border-t py-2 border-t-gray-300">
            ...
            <Link href="/">
                <img
                    class="rounded-full w-[30px] h-[30px] cursor-pointer"
